...
<html lang="th">
    ...
    <head>
        ...
        <link
            ...
            rel="stylesheet" />
        <script
            src="https://unpkg.com/leaflet-control-geocoder@2.4.0/dist/Control.Geocoder.js"></script>
        <style>
        :root {
    ...
    <body>
        ...
        let isFirstPosition = true; // เพิ่มตัวแปรเช็คว่าเป็นครั้งแรกหรือไม่
...
function showPosition(position) {
    ...
    // เปิด popup เฉพาะครั้งแรก
    if (isFirstPosition) {
        currentLocationMarker.openPopup();
        isFirstPosition = false; // ตั้งค่าเป็น false หลังจากแสดงครั้งแรก
    }
...
// เพิ่มการรีเซ็ต isFirstPosition ในฟังก์ชัน getLocation
function getLocation() {
    showLoading();
    if (navigator.geolocation) {
        if (watchId) {
        ...
        isFirstPosition = true; // รีเซ็ตเป็น true เมื่อเริ่มติดตามตำแหน่งใหม่
